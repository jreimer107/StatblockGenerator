...
>\n\
> ***General Ability Description.*** General Attack Description" % (name, size, monster_type, align, ac, hp, speeds, strength, get_mod(strength), dex, get_mod(dex), con, get_mod(con), intel, get_mod(intel), wis, get_mod(wis), cha, get_mod(cha), saving_throws, skills, senses, languages, cr, XP_BY_CR[cr])
